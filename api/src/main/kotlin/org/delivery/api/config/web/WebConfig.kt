...
class WebConfig(
    ...
    private val OPEN_API = listOf("/open-api/**")
    private val DEFAULT_EXCLUDE = listOf("/", "favicon.ico", "/error")
    private val SWAGGER = listOf("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**")
